          ...
          <div className={theme ? "dark-landing" : "columns-landing"}>
            <div className={theme ? "landing-1" : "columns-landing-1"}>
              ...
              <div className="shift">
                <div className={theme ? "dark-text-head" : "text-head"}>
                  ...
                  ConnectHub
                  <span
                    className={theme ? "dark-change-color" : "change-color"}>
                    {" "}
                  </span>
                </div>
                <div className={theme ? "dark-text-head" : "text-head"}>
                ...
                <div>
                  <input
                    ...
                    type="text"
                    id="join"
                    placeholder="Enter Meeting Id"></input>
                  <button
                    onClick={join}
                    className={theme ? "dark-join-button" : "join-button"}>
                    Join Meeting
            ...
            <div className={theme ? "landing-2" : "columns-landing-2"}>
              ...
              <div className={theme ? "dark-image1-out" : "image1-out"}>
                ...
                <img
                  className="image1"
                  src="https://miro.medium.com/max/3200/1*U0xqOjpBt-Xxkz3i5xbs_w.png"></img>
              </div>
            </div>
          </div>
          ...
          <div className={theme ? "dark-connect-landing" : "connect-landing"}>
            <div
              ...
              <div className={theme ? "dark-connect-main" : "connect-main"}>
                <div
                  className={
                    theme ? "dark-connect-head-in" : "connect-head-in"
                  }>
                  Stay Connected
                </div>
                <div
                  ...
                  ConnectHub is a smart networking and collaboration platform
                  that connects individuals, communities, and organizations. It
                  provides a centralized space where users can interact, share
                  knowledge, explore opportunities, and build meaningful
                  connections. Designed with simplicity and accessibility in
                  mind, ConnectHub empowers users to collaborate efficiently and
          ...
          <div
            ...
            <div className={theme ? "dark-about-outer" : "about-outer"}>
              ...
              <div className={theme ? "dark-about-main" : "about-main"}>
                ...
                ConnectHub offers a wide range of features including video
